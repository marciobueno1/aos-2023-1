create table cliente (id int8 not null, cpf varchar(255), endereco varchar(255), nome varchar(255), primary key (id))
create table compra (id int8 not null, numero_produtos int4 not null, valor_total float4 not null, cliente_id int8, primary key (id))
